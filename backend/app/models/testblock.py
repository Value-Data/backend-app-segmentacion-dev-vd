...
class TestBlock(SQLModel, table=True):
    ...
    fecha_creacion_tb: Optional[datetime] = Field(default=None)
    temporada_inicio: Optional[str] = Field(default=None, sa_column=Column(sa.NVARCHAR(20)))
...
class PosicionTestBlock(SQLModel, table=True):
    ...
    hilera: int
    posicion: int
    fecha_plantacion: Optional[datetime] = Field(default=None)
    fecha_alta: Optional[datetime] = Field(default=None)
    ...
    conduccion: Optional[str] = Field(default=None, sa_column=Column(sa.NVARCHAR(50)))
    marco_plantacion: Optional[str] = Field(default=None, sa_column=Column(sa.NVARCHAR(50)))
    fecha_creacion: Optional[datetime] = Field(default_factory=datetime.utcnow)
    fecha_modificacion: Optional[datetime] = Field(default=None)
