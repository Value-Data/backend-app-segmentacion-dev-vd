...
class Variedad(SQLModel, table=True):
    ...
    alelos: Optional[str] = Field(default=None, sa_column=Column(sa.NVARCHAR(500)))
    ...
    autofertil: Optional[bool] = Field(default=False)
    requerimiento_frio: Optional[str] = Field(default=None, sa_column=Column(sa.String(20)))
