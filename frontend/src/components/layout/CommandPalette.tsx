...
const pages = [
  ...
  { label: "Fenologia", to: "/fenologia", icon: Flower2, group: "Operaciones" },
  { label: "Mediciones Laboratorio", to: "/laboratorio", icon: FlaskConical, group: "Calidad" },
  { label: "Analisis de Calidad", to: "/laboratorio/analisis", icon: Microscope, group: "Calidad" },
  { label: "Reportes", to: "/reportes", icon: FileText, group: "Reportes" },
  { label: "Analisis General", to: "/analisis", icon: BarChart3, group: "Reportes" },
